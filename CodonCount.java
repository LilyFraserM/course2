...
public class CodonCount {
    ...
    private String getCodonWithCount() {
        //int largest = 0;
        int current = 0;
    ...
    public void test() {
        ...
        System.out.println("the codon that appears exactly  6times "+ getCodonWithCount()+"\t");
        System.out.println("and most common codon is "+largest+" with count "+map.get(largest)+"\t");  
        System.out.println("Counts of codons between "+start+" and "+end+" inclusive are:"+"\t");
        printCodonCounts(start, end);
        ...
        largest = getMostCommonCodon();
        System.out.println("the codon that appears exactly 4 times "+ getCodonWithCount()+"\t");
