...
/**
 * Write a description of caesarDecrypter1 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
//public class caesarDecrypter1 {
import edu.duke.FileResource;
...
public void decrypt() {
      //  FileResource fr = new FileResource();
       // return decryptTwoKeys(fr.asString());
        String encrypted = "Aptg Bn ctrthhpgxth pgt tbqpgzs Upgtltaa.";
        System.out.println("deprypted msg is " + decryptOneKey(encrypted));
    }
}
